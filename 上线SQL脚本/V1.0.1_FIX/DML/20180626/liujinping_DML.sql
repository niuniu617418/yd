#第一步：更新代扣数据
#select * from sd_account.tac_withholdorder t where t.projectId = 91104934363140096 order by t.createTime desc limit 1;

update tac_withholdorder set amount = 1560, status = 4  where orderNo = 166672605703569408 and projectId = 91104934363140096 and status = 3;
...
AND t3. STATUS = 4
WHERE t.projectId IN (91104934363140096);