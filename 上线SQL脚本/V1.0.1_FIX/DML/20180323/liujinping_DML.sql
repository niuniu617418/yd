...
where t.projectId in (88411773769633792,88844854821408768,89565504754176000,87661197016453120,91282744897703936,90745128402034688,77668511794618368);
...
WHERE
	t.projectId IN (88411773769633792,88844854821408768,89565504754176000,87661197016453120,91282744897703936,90745128402034688,77668511794618368)
