...
where t.projectId in (87973939829035008,86250937030561792,88895384302145536,90241603196702720,89921179967574016);
...
WHERE
	t.projectId IN (87973939829035008,86250937030561792,88895384302145536,90241603196702720,89921179967574016) 
