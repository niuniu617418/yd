...
where t.projectId in (86958100203982848,69602647606300672,89112222608936960,89677583754481664);
...
WHERE
	t.projectId IN (86958100203982848,69602647606300672,89112222608936960,89677583754481664)
