...
where t.projectId in (82353138526326784,89151103525998592,87171502545326080,90036495729053696,91145264831664128);
...
WHERE
	t.projectId IN (82353138526326784,89151103525998592,87171502545326080,90036495729053696,91145264831664128)
